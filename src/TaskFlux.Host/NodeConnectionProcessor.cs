...
{
    public NodeConnectionProcessor(NodeId id, PacketClient client, RaftConsensusModule<IRequest, IResponse> consensusModule, ILogger logger)
    {
        Id = id;
        Client = client;
    ...
    private RaftConsensusModule<IRequest, IResponse> ConsensusModule { get; }
