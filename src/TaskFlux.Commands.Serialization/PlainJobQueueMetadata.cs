...
internal class PlainJobQueueMetadata: IJobQueueMetadata
{
    private PlainJobQueueMetadata(QueueName queueName, uint count, uint maxSize)
    {
        QueueName = queueName;
        Count = count;
        MaxSize = maxSize;
    ...
    public struct Builder
    {
        ...
        public IJobQueueMetadata Build()
        {
            return new PlainJobQueueMetadata(QueueName, Count, MaxSize);
        }
    }
}